...
// the legacy classic AI account is retired. The harness only needs the
// connection string (``APPLICATIONINSIGHTS_CONNECTION_STRING``) — every
// other knob is at the defaults from C7.3.
